    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 text-center pt-8 pb-12">
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          <h1 className="text-4xl md:text-5xl text-[#39FF14] tracking-[0.2em] drop-shadow-[0_0_20px_rgba(57,255,20,0.5)]" style={{ fontFamily: "'Akira Expanded', sans-serif", textShadow: '0 0 10px rgba(57,255,20,0.6), 0 0 30px rgba(57,255,20,0.3)' }}>
            THE CREW
          </h1>
